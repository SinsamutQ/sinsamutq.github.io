            ...
            <div className="felx flex-col justity-center max-w-xs mx-auto bg-white shadow-xl rounded-xl p-5">
                ...
                <div className="text-center mt-5">
                    ...
                    <div className="flex align-center justify-center mt-4">
                        ...
                        <a className="text-3xl m-1 p-1 sm:m-2 sm:p-2 text-blue-600 hover:bg-blue-600 rounded-full hover:text-white transition-colors duration-300" href="https://github.com">
                            <FaFacebook/>
                            <span className="sr-only">Facebook</span>
                        </a><a className="text-3xl m-1 p-1 sm:m-2 sm:p-2 text-gray-800 hover:bg-gray-800 rounded-full hover:text-white transition-colors duration-300" href="https://github.com">
                            <RiInstagramFill/>
